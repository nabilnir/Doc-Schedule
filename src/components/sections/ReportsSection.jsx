...
const ReportsSection = () => {
    return (
        <section className="py-[120px] bg-black text-white overflow-hidden" id="reports">
            <div className="container mx-auto max-w-[1440px] px-8">
                <div className="flex flex-col lg:flex-row items-center gap-20">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <p className="text-[20px] text-white/60 leading-relaxed mb-10">
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="relative group">
                            ...
                            <div className="relative bg-[#1A1A1A] rounded-[40px] p-12 border border-white/10">
                                <div className="border-2 border-dashed border-white/10 rounded-3xl p-10 flex flex-col items-center text-center space-y-4 hover:border-[#7BA1C7] transition-colors cursor-pointer">
                                    <div className="w-20 h-20 bg-white/5 rounded-full flex items-center justify-center">
                                        <UploadCloud className="w-10 h-10 text-[#7BA1C7]" />
                                    </div>
                                    <div>
                                        <p className="text-xl font-bold">Drag & Drop Reports</p>
